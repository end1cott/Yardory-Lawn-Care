...
slug: "philadelphia-lawn-care-calendar"
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can I apply a fall pre-emergent and overseed at the same time?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. The pre-emergent barrier will block germination. Either overseed with a seed-safe program (e.g., mesotrione) or use a fall pre-emergent for Poa annua—but not both."
      }
    },
    {
      "@type": "Question",
      "name": "How much nitrogen should I apply in the fall?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For tall fescue/KBG in Zone 7a, target about 2–3 lb N per 1,000 ft² total for the fall, split across 2–3 applications in September, October, and (if still actively growing) November."
      }
    },
    {
      "@type": "Question",
      "name": "What mowing height is best in summer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Maintain 3.5–4.0 inches, especially in heat and in shaded areas, to reduce stress and suppress weeds."
      }
    }
  ]
}
